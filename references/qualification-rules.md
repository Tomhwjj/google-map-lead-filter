...
| 公司规模 | 20 | 大型(跨国/全国)≥18 · 中大型13-17 · 中型6-12 · 小型1-5 · 未确认0 |
| 触达 | 15 | 电话(可加WhatsApp) 8 · Facebook 4 · 邮箱3（底线） |
| 活跃度 | 10 | 近6月动态 8-10 · 近1年更新 5-7 · 静态 1-4 · 未确认0 |
...
> ⚠️ **批量数据占位默认值**：Google Maps 批量抓的安装商若没逐个背调，规模/活跃是统一占位值（不是真判断），UI 依据列会标「未确认」。别把占位值当真实分级，重点客户需补背调核实规模/活跃。
